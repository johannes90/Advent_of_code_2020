...
for turn in range(NUM_STARTING_NUMBERS + 1, GAME_LEN + 1):
    ...
    # Last number is new
        ...
        diff = turn-1 - spoken[now_spoken][-2]
        now_spoken = diff

    # update indices and last spoken map
    if now_spoken in spoken:
        indices_last_spoken = spoken[now_spoken]
    ...
    spoken[now_spoken] = indices_last_spoken

elapsed_time = time.time() -time0

print('2020th spoken number is: {}'.format(now_spoken)) 
